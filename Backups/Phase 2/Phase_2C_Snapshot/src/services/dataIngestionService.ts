...
import { analyzeKeyIssuesAndPriorities } from './priorityEngine';
...
export function ingestConsultationDataset(
  ...
  // Step: Execute Explainable Key Issues & Multi-Factor Priority Engine (Phase 2C)
  const priorityAnalysis = analyzeKeyIssuesAndPriorities(analysisResult.topics, enrichedComments);
